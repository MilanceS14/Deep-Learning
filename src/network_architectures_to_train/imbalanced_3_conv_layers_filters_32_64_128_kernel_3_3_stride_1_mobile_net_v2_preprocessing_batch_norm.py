...
model_save_path = os.path.join(trained_models_path, 'imbalanced_3_conv_layers_filters_32_64_128_kernel_3_3_stride_1_mobile_net_v2_preprocessing_batch_norm')
