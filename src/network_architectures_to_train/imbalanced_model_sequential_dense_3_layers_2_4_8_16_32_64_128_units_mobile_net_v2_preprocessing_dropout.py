...
model_save_path = os.path.join(trained_models_path, 'imbalanced_model_sequential_dense_3_layers_2_4_8_16_32_64_128_units_mobile_net_v2_preprocessing_dropout')
