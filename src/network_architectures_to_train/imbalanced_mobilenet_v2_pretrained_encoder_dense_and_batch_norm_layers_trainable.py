...
model_save_path = os.path.join(trained_models_path, 'imbalanced_mobilenet_v2_pretrained_encoder_dense_and_batch_norm_layers_trainable')
...
x = backbone.get_layer('global_average_pooling2d').output
