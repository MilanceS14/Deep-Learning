...
model_save_path = os.path.join(trained_models_path, 'imbalanced_1_conv_layer_filters_32_kernel_3_3_stride_1_mobile_net_v2_preprocessing_batch_norm_max_pool')
